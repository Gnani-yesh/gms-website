    ...
    <section className="relative isolate overflow-hidden pt-36 sm:pt-44 md:pt-56">
      ...
      <div className="container relative">
        ...
        <div className="mx-auto mt-8 max-w-[1100px] text-center sm:mt-10 md:mt-12">
          ...
          >
            We work with a small number of partners each year. The work below
            is curated — websites, platforms, brand systems and growth
            programs we&apos;re proud to keep operating.
          </motion.p>
